...
audio2.play();
   ...
   function stop(){
    ...
    if( player.score>player.highScore){
        ...
        highScore.innerText = 'Pontuação máxima'+'\n'+( player.highScore);
        }
    startScreen.classList.remove('hide');
    startScreen.innerHTML = "Fim de jogo <br> Sua pontuação final = " + (player.score ) + "<br>Sua pontuação mais alta ="+( player.highScore)+" <br>Pressione para reiniciar o jogo.";
   }
